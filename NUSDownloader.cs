...
namespace LRLD
{
	public class NUSDownloader : Page, IComponentConnector
	{
		[CompilerGenerated]
		[Serializable]
		private sealed class <>c
		{
			public static readonly NUSDownloader.<>c <>9 = new NUSDownloader.<>c();
		...
		public NUSDownloader(CookieContainer AuthReceive, string user_id, string session_id)
		{
			...
			this.Telemetry.Context.User.Id = "NUS_" + user_id;
		...
		private void Download_Click(object sender, RoutedEventArgs e)
		{
			...
			RestClient client = new RestClient("https://www-lawnet-sg.lawproxy1.nus.edu.sg/lawnet/group/lawnet/legal-research/basic-search")
			{
			...
			if (client.Execute(request).ResponseUri.ToString() != "https://www-lawnet-sg.lawproxy1.nus.edu.sg/lawnet/group/lawnet/legal-research/basic-search")
			{
		...
		{
			NUSDownloader.<>c__DisplayClass25_0 <>c__DisplayClass25_ = new NUSDownloader.<>c__DisplayClass25_0();
		...
		private void Download(string citation, int i)
		{
			if (this.DLS.Items[i].ToString() == "In Download Queue")
			{
				...
				if (citation.Contains("SGHC") || citation.Contains("SGCA") || citation.Contains("SGSAB"))
				{
					...
					client.BaseUrl = new Uri("https://www-lawnet-sg.lawproxy1.nus.edu.sg/lawnet/group/lawnet/page-content?p_p_id=legalresearchpagecontent_WAR_lawnet3legalresearchportlet&p_p_lifecycle=1&p_p_state=normal&p_p_mode=view&p_p_col_id=column-2&p_p_col_count=1&_legalresearchpagecontent_WAR_lawnet3legalresearchportlet_action=openContentPage");
				...
				if ((citation.Contains("SLR") || citation.Contains("Ch") || citation.Contains("Fam") || citation.Contains("AC") || citation.Contains("A.C.") || citation.Contains("WLR") || citation.Contains("QB") || citation.Contains("SSAR")) && !citation.Contains("SSLR") && !citation.Contains("FMSLR") && !this.PreferHTMLState())
				{
					...
					client.BaseUrl = new Uri("https://www-lawnet-sg.lawproxy1.nus.edu.sg/lawnet/group/lawnet/page-content?p_p_id=legalresearchpagecontent_WAR_lawnet3legalresearchportlet&p_p_lifecycle=2&p_p_resource_id=viewPDFSourceDocument");
					...
					if (citation.Contains("SLR") || citation.Contains("SSAR"))
					{
						if (citation.Contains("SSAR"))
						{
							...
							if ((arg_879_1 = NUSDownloader.<>c.<>9__26_7) == null)
							{
								arg_879_1 = (NUSDownloader.<>c.<>9__26_7 = new Func<int, string>(NUSDownloader.<>c.<>9.<Download>b__26_7));
							}
					...
					else
					{
						if (citation.Contains("WLR"))
						{
							...
							if ((arg_90D_1 = NUSDownloader.<>c.<>9__26_8) == null)
							{
								arg_90D_1 = (NUSDownloader.<>c.<>9__26_8 = new Func<int, string>(NUSDownloader.<>c.<>9.<Download>b__26_8));
							}
						...
						if (citation.Contains("AC") || citation.Contains("QB"))
						{
							...
							if ((arg_9AA_1 = NUSDownloader.<>c.<>9__26_9) == null)
							{
								arg_9AA_1 = (NUSDownloader.<>c.<>9__26_9 = new Func<int, string>(NUSDownloader.<>c.<>9.<Download>b__26_9));
							}
				...
				client.BaseUrl = new Uri("https://www-lawnet-sg.lawproxy1.nus.edu.sg/lawnet/group/lawnet/page-content?p_p_id=legalresearchpagecontent_WAR_lawnet3legalresearchportlet&p_p_lifecycle=1&p_p_state=pop_up&p_p_mode=view&p_p_col_id=column-2&p_p_col_count=1&_legalresearchpagecontent_WAR_lawnet3legalresearchportlet_action=viewDocumentInReadingPane&highlightActive=true");
		...
		public void InitializeComponent()
		{
			...
			Uri resourceLocater = new Uri("/LRLD;component/nusdownloader.xaml", UriKind.Relative);
